...
class InspectionReportViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print(parms);
        Alamofire.request(vinsLogReportVeiw, method: .post, parameters: parms).responseJSON { (resp) in
            ...
            if resp.result.value != nil
            {
                ...
                if !statuscode.isEmpty
                {
                    ...
                    DispatchQueue.main.async {
                        ...
                        vContrroller.mytitle = "Inspection Report";
    ...
    @IBAction func searchingTapped(_ sender: UITextField) {
        ...
        if sender.text != ""
        {
            ...
            for i in 0..<fdata.count
            {
                ...
                var buildTitle3 = buildData["iname"].stringValue;
    ...
    @IBAction func datepopTapped(_ sender: Any) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "signinlogCell") as! VinsCellClass
        cell.mroom.text = dataDemo[indexPath.row]["mtitle"].stringValue;
        cell.address.text = dataDemo[indexPath.row]["address"].stringValue;
         cell.institle.text = dataDemo[indexPath.row]["iname"].stringValue;
        cell.datename.text = dataDemo[indexPath.row]["idate"].stringValue;
    ...
    @objc func oktapped(_ sender : UIButton)
    {
        ...
        for l in 0..<fdata.count
        {
            ...
            let mydate = fdata[l]["idate"].stringValue
            if !mydate.isEmpty
            {
    ...
    func callreportData()
    {
        ...
        let Buildingapi = "\(vinsLogReport)\(userid)/\(usertype)"
...
class VinsCellClass : UITableViewCell
{
