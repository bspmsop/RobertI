//
//  EqipmentTestReportViewController.swift
//  Rathe_Associates
//
...
class EqipmentTestReportViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    @IBAction func searchingTapped(_ sender: UITextField) {
        ...
        if sender.text != ""
        {
            ...
            for i in 0..<fdata.count
            {
                ...
                var buildTitle = buildData["mtitle"].stringValue;
                var buildTitle2 = buildData["ename"].stringValue;
                var buildTitle3 = buildData["etname"].stringValue;
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "signinlogCell") as! VequipmentTestReportCellClss
        cell.mroom.text = dataDemo[indexPath.row]["mtitle"].stringValue
        cell.address.text = dataDemo[indexPath.row]["address1"].stringValue
        cell.testname.text = dataDemo[indexPath.row]["etname"].stringValue
        cell.equipmentName.text = dataDemo[indexPath.row]["ename"].stringValue
        cell.datesss.text = dataDemo[indexPath.row]["edate"].stringValue
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print(parms);
        Alamofire.request(vequipmentTestReportsVeiw, method: .post, parameters: parms).responseJSON { (resp) in
            ...
            if resp.result.value != nil
            {
                ...
                if !statuscode.isEmpty
                {
                    ...
                    DispatchQueue.main.async {
                        ...
                        vContrroller.mytitle = "Equipment Test Report";
   ...
   @objc func gettheDate(_ sender : UIDatePicker)
   {
    ...
    @objc func oktapped(_ sender : UIButton)
    {
        ...
        for l in 0..<fdata.count
        {
            ...
            let mydate = fdata[l]["edate"].stringValue
            if !mydate.isEmpty
            {
    ...
    func callreportData()
    {
        ...
        let Buildingapi = "\(vequipmentTestReports)\(userid)/\(usertype)"
...
class VequipmentTestReportCellClss : UITableViewCell
{
    @IBOutlet weak var mroom: UILabel!
    @IBOutlet weak var address: UILabel!
    @IBOutlet weak var testname: UILabel!
    @IBOutlet weak var equipmentName: UILabel!
    @IBOutlet weak var datesss: UILabel!
