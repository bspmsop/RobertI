//
//  CBInspectionViewController.swift
//  Rathe_Associates
//
//  Created by nagamani on 01/04/19.
...
class CBInspectionViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func searchinftapped(_ sender: UITextField) {
            ...
            if resp.result.value != nil
            {
                ...
                if !statuscode.isEmpty
                {
                    ...
                    DispatchQueue.main.async {
                        ...
                        vContrroller.mytitle = "Inspections";
    ...
    @IBAction func datepopTapped(_ sender: UIButton) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "inspectioncell")
...
class CBInspectionCellClass : UITableViewCell
{
    
    @IBOutlet weak var adderesss: UILabel!
    @IBOutlet weak var inametitle: UILabel!
    
    @IBOutlet weak var datettt: UILabel!
