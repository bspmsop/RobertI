//
//  RepairNCostReportViewController.swift
//  Rathe_Associates
//
...
class RepairNCostReportViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
 ...
 var hud = MBProgressHUD();
    ...
    @IBAction func searchingTapped(_ sender: UITextField) {
        ...
        if sender.text != ""
        {
            ...
            for i in 0..<fdata.count
            {
                ...
                var buildTitle = buildData["equipment"].stringValue;
                var buildTitle2 = buildData["mechanical"].stringValue;
                var buildTitle3 = buildData["vendor"].stringValue;
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "signinlogCell") as! VRepairCostReportCellClass
        cell.eqpname.text = dataDemo[indexPath.row]["equipment"].stringValue;
        cell.address.text = dataDemo[indexPath.row]["address"].stringValue;
        cell.mtitle.text = dataDemo[indexPath.row]["mechanical"].stringValue;
        cell.testname.text = dataDemo[indexPath.row]["vendor"].stringValue;
        cell.datename.text = dataDemo[indexPath.row]["rdate"].stringValue;
    ...
    @objc func oktapped(_ sender : UIButton)
    {
        ...
        for l in 0..<fdata.count
        {
            ...
            let mydate = fdata[l]["rdate"].stringValue
            if !mydate.isEmpty
            {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print(parms);
        Alamofire.request(vrepaircostVeiw, method: .post, parameters: parms).responseJSON { (resp) in
            ...
            if resp.result.value != nil
            {
                ...
                if !statuscode.isEmpty
                {
                    ...
                    DispatchQueue.main.async {
                        ...
                        vContrroller.mytitle = "Repair Cost Report";
    ...
    func callreportData()
    {
        ...
        let Buildingapi = "\(vrepaircost)\(userid)/\(usertype)"
...
class VRepairCostReportCellClass : UITableViewCell
{
    
    @IBOutlet weak var eqpname: UILabel!
