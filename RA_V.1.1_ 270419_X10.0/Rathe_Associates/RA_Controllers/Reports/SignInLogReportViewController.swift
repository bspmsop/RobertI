//
//  SignInLogReportViewController.swift
//  Rathe_Associates
//
...
class SignInLogReportViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func searchingTapped(_ sender: UITextField) {
        ...
        if sender.text != ""
        {
            ...
            for i in 0..<fdata.count
            {
                ...
                var buildTitle3 = buildData["mechanical"].stringValue;
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "signinlogCell") as! VsignInLogReportCell
        cell.uname.text = dataDemo[indexPath.row]["fullname"].stringValue
         cell.address.text = dataDemo[indexPath.row]["address"].stringValue
         cell.room.text = dataDemo[indexPath.row]["mechanical"].stringValue
        let dattee = dataDemo[indexPath.row]["date"].stringValue
         let timemeee = dataDemo[indexPath.row]["time"].stringValue
        
        cell.datetitle.text =  "\(dattee) \(timemeee)";
    ...
    @objc func oktapped(_ sender : UIButton)
    {
        ...
        for l in 0..<fdata.count
        {
            ...
            let mydate = fdata[l]["date"].stringValue
            if !mydate.isEmpty
            {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        print(parms);
        Alamofire.request(vsigninLogReportVeiw, method: .post, parameters: parms).responseJSON { (resp) in
            ...
            if resp.result.value != nil
            {
                ...
                if !statuscode.isEmpty
                {
                    ...
                    DispatchQueue.main.async {
                        ...
                        vContrroller.mytitle = "Sign In Log Report";
    ...
    func callreportData()
    {
        ...
        let Buildingapi = "\(vsigninLogReport)\(userid)/\(usertype)"
...
class VsignInLogReportCell : UITableViewCell
{
