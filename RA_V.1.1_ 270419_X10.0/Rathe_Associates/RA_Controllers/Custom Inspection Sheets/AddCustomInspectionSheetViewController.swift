//
//  AddCustomInspectionSheetViewController.swift
//  Rathe_Associates
//
...
class AddCustomInspectionSheetViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIPickerViewDataSource, UIPickerViewDelegate, UITextViewDelegate {
...
//            print(optionarray);
    ...
    @objc func addMechancialRoomPopupSubmitted(_ sender : UIBotton)
    {
        ...
        {
            popTabl.wariningLab.text = "Please enter interval in days";
        ...
        else
        {
                ...
                samplePrimaryfield.text = popTabl.roomNameField.text!
                 primaryData["idate"] = popTabl.roomNameField.text!
    ...
    @objc func hidePopView(_ sender : UIButton)
    {
        ...
        self.popTabl.roomNameField.endEditing(true);
        primaryData["inspection_interval"] = "";
        primaryData["idate"] = "";
        UIView.animate(withDuration: 0.5, animations: {
            self.popTabl.frame = CGRect.init(x: 0, y: self.view.frame.height + 42, width: self.view.frame.width, height: self.view.frame.height)
        }) { (isSuccess) in
                ...
                if resp.result.value != nil
                {
                    ...
                    if statuscode == 1
                    {
                        ...
                        DispatchQueue.main.async {
                            ...
                            let alert = UIAlertController.init(title:  translator("Success!"), message: translator("Successfully created custom form"), preferredStyle: .alert);
            ...
            if indexPath.row == 0
            {
                ...
                cell.topPadding.constant = 20
                 ...
                 cell.saveBtn.backgroundColor = UIColor.init(red: 32/255, green: 191/255, blue: 5/255, alpha: 1.0)
                    cell.saveBtn.setTitle("Create Custom Form", for: .normal)
...
//
   ...
   @objc func isRequiredTapped(_ sender : UIBotton)
    ...
    func calldefaultData()
    {
        ...
        let Buildingapi = "\(vAddCustomInspectionDetail)\(userid)/\(usertype)"
        print(Buildingapi);
                        ...
                        if uid == "1" || uid == "2" ||  uid == "3"
                        {
                            if self.companyListData.count > 0
                            {
                                ...
                                self.primaryData["comid"] = self.companyListData[0]["cid"].stringValue;
                                 self.mechanicalListData = self.companyListData[0]["mechs"].arrayValue;
                            }
