//
//  EditEquipmentTestViewController.swift
//  Rathe_Associates
//
...
class EditEquipmentTestViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UIPickerViewDataSource, UIPickerViewDelegate, UITextViewDelegate {
    ...
    @IBOutlet weak var ispectionHeader: UILabel!
    var primaryData :  Dictionary<String, String> = ["company" : "", "mechanical_Room": "", "inspection_name": "", "inspection_interval" : "",  "comid":"" ];
        ...
        if row < generalPickerData.count
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    self.editTable.reloadRows(at: [samplePrimaryfield.texet], with: .fade)
    ...
    func pickerView(_ pickerView: UIPickerView, attributedTitleForRow row: Int, forComponent component: Int) -> NSAttributedString? {
        ...
        if samplePrimaryfield.texet.section == 0
        {
            ...
            {
                let attributed = NSAttributedString.init(string: "", attributes: [NSAttributedStringKey.foregroundColor : UIColor.white]);
    ...
    @objc func deleteSection(_ sender : UIBotton)
    {
        ...
        DispatchQueue.main.async {
            ...
            UIView.animate(withDuration: 0.5, animations: {
                ...
                self.editTable.scrollToRow(at: IndexPath.init(row: 0, section: sender.tag + 1), at: .top, animated: false);
                self.view.endEditing(true);
    ...
    @objc func addSectionInTable(_ sender : UIBotton)
    {
        DispatchQueue.main.async {
            ...
            let sample : Dictionary<String, Any> =  ["section_id" : 0, "head" : "", "order" : orderstr, "cols" : "1", "fields": [["label":"", "order" : "1", "itype" : "1","typename": "Text box", "ioptions" : "", "required" : "N", "ivalids" : "2", "idefault" : "","id" : 0]]]
        ...
        UIView.animate(withDuration: 0.5, animations: {
            ...
            DispatchQueue.main.async(execute: {
                self.editTable.reloadData();
                self.editTable.scrollToRow(at: IndexPath.init(row: 0, section: sender.tag + 2), at: .top, animated: false);
                self.view.endEditing(true);
            })
    ...
    @objc func addRowInTable(_ sender : UIBotton)
    {
        ...
        UIView.animate(withDuration: 0.5, animations: {
            ...
            self.editTable.reloadSections(IndexSet.init(integer: sender.setTitlein.section), with: .none);
            self.editTable.scrollToRow(at: IndexPath.init(row: fdata.count - 1, section: sender.setTitlein.section), at: .none, animated: false);
    ...
    @objc func saveAsTapped(_ sender : UIBotton)
    {
        ...
        vController.isfrominspection = false;
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        else if  indexPath.section == sectionData.count + 1
        {
            ...
            if indexPath.row == 0
            {
                ...
                cell.saveBtn.setTitle("Update Test Form", for: .normal)
    ...
    func calldefaultData()
    {
        ...
        let Buildingapi = "\(vEfficiencyTestEditDetailAPI)\(userid)/\(usertype)/\(sinspectioon_id)"
        print(Buildingapi);
                ...
                if  scode != nil && temp != JSON.null
                {
                    ...
                    if testdata != nil
                    {
                        ...
                        DispatchQueue.main.async {
                            ...
                            self.ispectionHeader.text =  temp["name"].stringValue
                            
                            
                            
                            self.editTable.reloadData();
                            self.editTable.isHidden = false;
